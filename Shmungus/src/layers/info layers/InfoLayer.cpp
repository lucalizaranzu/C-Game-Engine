...
void InfoLayer::onAttach() {
	...
	infoSpace.submitDynamicTextBox(DynamicTextBox("Player Position: ~§§uplayerX, ~§§uplayerY, ~§§uplayerZ", vec2(0, 0.04f), vec2(0.5f, 0.1f), 5, 1, 10, Shmingo::LEFT));
	infoSpace.submitDynamicTextBox(DynamicTextBox("FPS: ~§§ufps", vec2(0, 0), vec2(0.5f, 0), 5, 1, 10, Shmingo::LEFT));
