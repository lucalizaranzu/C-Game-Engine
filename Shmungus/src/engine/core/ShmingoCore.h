...
#define se_Log(x);
#endif
#define se_error(x) std::cout << x << std::endl;
...
#define se_getApplicationInfo se_application.getApplicationInfo
#define se_onTick se_application.getOnTick()
#define se_isValidInfoKey se_application.isInApplicationInfo
...
#define se_MOUSE_BUTTON_1 GLFW_MOUSE_BUTTON_1
#define se_MOUSE_BUTTON_2 GLFW_MOUSE_BUTTON_2
#define se_MOUSE_BUTTON_3 GLFW_MOUSE_BUTTON_3
#define se_MOUSE_BUTTON_4 GLFW_MOUSE_BUTTON_4
#define se_MOUSE_BUTTON_5 GLFW_MOUSE_BUTTON_5
#define se_MOUSE_BUTTON_6 GLFW_MOUSE_BUTTON_6
#define se_MOUSE_BUTTON_7 GLFW_MOUSE_BUTTON_7
#define se_MOUSE_BUTTON_8 GLFW_MOUSE_BUTTON_8

#define se_MOUSE_LEFT GLFW_MOUSE_BUTTON_LEFT
#define se_MOUSE_RIGHT GLFW_MOUSE_BUTTON_RIGHT

#define se_PRESS GLFW_PRESS
#define se_RELEASE GLFW_RELEASE
